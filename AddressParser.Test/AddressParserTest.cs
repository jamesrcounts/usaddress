namespace AddressParser.Test
{
    ...
    public class AddressParserTest
    {
        ...
        {
            VerifyNormalizedAddress("N6W23001 BLUEMOUND ROAD, ROLLING MEADOWS, IL, 12345");
        }
        ...
        {
            VerifyNormalizedAddress("500 SOUTH STREET VIRGINIA BEACH VIRGINIA 23452");
        }

        [Test]
        public void CanParseAddressWithoutPunctuation()
        {
            VerifyNormalizedAddress("999 West 89th Street Apt A New York NY 10024");
        }
        ...
        {
            var parser = new AddressParser();
            var address = parser.ParseAddress(addressText);
            Approvals.Verify(address);
        }

        private static void VerifyParsedAddress(string addressText)
        {
            var parser = new AddressParser();
            var address = parser.ParseAddress(addressText, false);
            Approvals.Verify(address);
        }
    }
}